...
type ThisYearCategoriesChartProps = {
...
const ThisYearCategoriesChart = ({ records }: ThisYearCategoriesChartProps) =>{
    ...
    const finalInfo = (data: RecordsInterface[]) => {
        const result = data.reduce((accum: ChartData, record) => {
    ...
    const chartInfo = finalInfo(thisYearRecords);
...
export default ThisYearCategoriesChart;